            ...
            <div>
              ...
              >
                ...
                <ModalFooter className="d-flex justify-content-around">
                  ...
                  <div>
                    <Button color="outline-info" onClick={this.requestToggle}>Request</Button>
                    <Modal
                    ...
                    >
                      ...
                      <ModalBody>
                      <textarea onChange={(e) => this.handleOnChange(e)} value={this.state.requestMessage} className="form-control" aria-label="With textarea"></textarea>
                      </ModalBody>
                      <ModalFooter>
                        <Button
                          name={this.props.toy._id}
                          color="outline-success"
                          onClick={() => this.sendNotification(this.props.toy._id, this.props.toy.userID, receiver, sender)}
                        >
                          Send
                    </Button>{" "}
                        <Button color="outline-info" onClick={this.requestToggle}>
                          Cancel
                    </Button>
                      </ModalFooter>
                    </Modal>
